        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('asset/images/loginBackground.png'),
                  fit: BoxFit.fill)),
          child: Form(
            key: _formKey,
            child: Column(
              ...
              children: <Widget>[
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          image: AssetImage('asset/images/reminderGIF.gif'))),
                ),
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (val) => setState(() => usern = val),
                  ),
                ),
                Padding(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState.validate()) {
                              dynamic result = await _authService
                                  .signInWithEmailAndPassword(usern, passw);
                              if (result == null) {
                                setState(() => error =
