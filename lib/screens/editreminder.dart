...
class _editReminderState extends State<editReminder> {
  ...
  Widget build(BuildContext context) {
    TextEditingController title =
        new TextEditingController(text: titlee.toString());
    TextEditingController body =
        new TextEditingController(text: bodyy.toString());
    update() async {
      print(idd);
      print(userrr);
      ...
      await Firestore.instance
        ...
        'title': title.text,
        'body': body.text
      }); //setData({ 'title': titlee.text, 'body': bodyy.text });
            ...
            child: Container(
              ...
              decoration: new BoxDecoration(
                  image: new DecorationImage(
                      image:
                          AssetImage('asset/images/editReminderBackground.png'),
                      fit: BoxFit.cover)),
              child: Column(
                children: <Widget>[
